...
export const DESIGN_PATTERNS_TOPICS: Topic[] = [
  {
    ...
    description:
      'Singleton, Factory Method, Abstract Factory, Builder, and Prototype patterns in Java.',
...
new LoginForm(factory).render();`,
  ...
  },
  {
    ...
    description:
      'Strategy, Observer, Template Method, Chain of Responsibility, and Command patterns in Java.',
    categoryId: 'design-patterns',
    icon: '🎭',
    difficulty: 'Intermediate',
    tags: [
...
chain.handle(incomingRequest); // flows: auth → rate limit → logic`,
  ...
  },
  {
    ...
    description:
      'The five SOLID principles of object-oriented design — SRP, OCP, LSP, ISP, DIP with practical Java examples.',
    categoryId: 'design-patterns',
    icon: '🏛️',
    difficulty: 'Intermediate',
    tags: [
