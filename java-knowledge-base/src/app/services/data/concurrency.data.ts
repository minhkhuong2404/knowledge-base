...
export const CONCURRENCY_TOPICS: Topic[] = [
  {
    ...
    description:
      'Creating threads, thread lifecycle states, thread methods, daemon threads, and thread safety basics.',
...
public class ThreadStateDemo {
  ...
  },
  {
    ...
    description:
      'Happens-before relationships, volatile semantics, instruction reordering, and memory visibility guarantees.',
    categoryId: 'concurrency',
    icon: '🧠',
    difficulty: 'Advanced',
    tags: [
...
// that if the reader sees ready=true, it also sees number=42.`,
  ...
  },
  {
    ...
    description:
      "ThreadPoolExecutor's 7 parameters, 4 rejection policies, thread pool sizing, and lifecycle management.",
    categoryId: 'concurrency',
    icon: '🏊',
    difficulty: 'Advanced',
    tags: [
...
log.info("Pool: active={}, queued={}, completed={}",
  ...
  },
  {
    ...
    description:
      'synchronized vs ReentrantLock, read-write locks, optimistic locking with CAS, and lock-free algorithms.',
    categoryId: 'concurrency',
    icon: '🔐',
    difficulty: 'Advanced',
    tags: [
...
public class DeadlockPrevention {
  ...
  },
  {
    ...
    description:
      'The framework behind ReentrantLock, CountDownLatch, Semaphore — CLH queue, state management, and custom synchronizers.',
    categoryId: 'concurrency',
    icon: '🏗️',
    difficulty: 'Advanced',
    tags: [
...
public class PhaserDemo {
  ...
  },
  {
    ...
    description:
      'Compare-And-Swap operation, ABA problem, AtomicInteger/Long/Reference, LongAdder, and lock-free programming.',
    categoryId: 'concurrency',
    icon: '⚛️',
    difficulty: 'Advanced',
    tags: [
...
public class LockFreeStack<E> {
  ...
  },
  {
    ...
    title: 'ThreadLocal',
    description:
      'Thread-local variables, usage patterns, memory leak pitfalls, and InheritableThreadLocal.',
    categoryId: 'concurrency',
    icon: '📌',
    difficulty: 'Intermediate',
    tags: [
...
public class SafeDateFormatter {
  ...
  },
  {
    ...
    description:
      'Composable async programming — chaining, combining, error handling, timeouts, and best practices.',
    categoryId: 'concurrency',
    icon: '🔮',
    difficulty: 'Advanced',
    tags: [
...
public class AsyncRetry {
  ...
  },
  {
    ...
    description:
      "Java 21's lightweight threads — scalability without complexity, structured concurrency, and migration guide.",
    categoryId: 'concurrency',
    icon: '🚀',
    difficulty: 'Advanced',
    tags: [
...
public static void benchmark() throws InterruptedException {
  ...
  },
  {
    ...
    description:
      'ConcurrentHashMap, CopyOnWriteArrayList, BlockingQueue, ConcurrentLinkedQueue — thread-safe collections.',
    categoryId: 'concurrency',
    icon: '📦',
    difficulty: 'Intermediate',
    tags: [
