...
export const IO_TOPICS: Topic[] = [
    {
      ...
      description: 'InputStream/OutputStream, Reader/Writer, byte streams vs character streams, and buffering.',
      categoryId: 'io',
      icon: '📄',
      difficulty: 'Beginner',
...
try (var writer = Files.newBufferedWriter(Path.of("output.csv"), StandardCharsets.UTF_8)) {
    ...
    },
    {
      id: 'nio-basics',
      title: 'Java NIO',
      description: 'Channels, Buffers, Selectors — non-blocking IO for high-performance network and file operations.',
      categoryId: 'io',
      icon: '🔀',
...
try (FileChannel fc = FileChannel.open(Path.of("big.dat"), StandardOpenOption.READ)) {
    ...
    },
    {
      ...
      description: 'Blocking IO, Non-blocking IO, Asynchronous IO — understanding the 5 IO models and their trade-offs.',
      categoryId: 'io',
      icon: '🔄',
      difficulty: 'Advanced',
...
//     .childHandler(new MyChannelInitializer());`
    ...
    },
    {
      ...
      description: 'Decorator pattern in Java IO, Adapter pattern, and how the IO library is architecturally designed.',
      categoryId: 'io',
      icon: '🎨',
      difficulty: 'Intermediate',
