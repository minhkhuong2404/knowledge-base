...
export const CORE_JAVA_TOPICS: Topic[] = [
    {
      ...
      icon: '📝',
      difficulty: 'Beginner',
      tags: ['Data Types', 'Primitives', 'String', 'Autoboxing', 'Pass-by-Value', 'JDK', 'JRE', 'JVM', 'String Pool', 'Immutability', 'hashCode', 'equals', 'Wrapper Classes', 'Integer Cache'],
      content: [
        {
    ...
    },
    {
      ...
      icon: '🎯',
      difficulty: 'Beginner',
      tags: ['OOP', 'Encapsulation', 'Inheritance', 'Polymorphism', 'Abstraction', 'Constructors', 'Method Overloading', 'Method Overriding', 'Interface', 'Abstract Class', 'Composition'],
      content: [
        {
          heading: 'Overview',
...
public class AuditedOrderService implements Loggable, Auditable {
    ...
    },
    {
      ...
      tags: ['static', 'final', 'volatile', 'transient', 'synchronized', 'Enum', 'Keywords', 'Inner Classes', 'Marker Interface', 'Static Import', 'EnumSet', 'EnumMap', 'Access Modifiers'],
      content: [
        {
...
public class FinalReferencePitfall {
    ...
    },
    {
      ...
      icon: '🔤',
      difficulty: 'Intermediate',
      tags: ['Generics', 'Type Safety', 'Wildcards', 'Type Erasure', 'PECS', 'Bounded Types', 'Diamond Operator', 'Generic Methods'],
      content: [
        {
...
public static double sum(List<? extends Number> numbers) {
    ...
    },
    {
      ...
      icon: '⚠️',
      difficulty: 'Beginner',
      tags: ['Exceptions', 'Try-Catch', 'Error Handling', 'Try-With-Resources', 'Checked Exceptions', 'Unchecked Exceptions', 'RuntimeException', 'Exception Chaining', 'AutoCloseable'],
      content: [
        {
...
public class OrderProcessor {
    ...
    },
    {
      ...
      icon: '🔍',
      difficulty: 'Advanced',
      tags: ['Reflection', 'Class', 'Method', 'Annotation', 'Dynamic', 'MethodHandle', 'Runtime Inspection', 'setAccessible', 'Framework Internals'],
      content: [
        {
...
// ["name: Name is required", "age: Age must be 1-150", "email: Field must not be empty"]`
    ...
    },
    {
      ...
      icon: '🎭',
      difficulty: 'Advanced',
      tags: ['Proxy', 'Dynamic Proxy', 'CGLIB', 'AOP', 'Spring', 'InvocationHandler', 'Bytecode Generation', 'Cross-Cutting Concerns'],
      content: [
        {
          heading: 'Why Proxy',
...
proxy.deleteProduct(1L); // clears cache`
    ...
    },
    {
      ...
      icon: '💾',
      difficulty: 'Intermediate',
      tags: ['Serialization', 'Serializable', 'serialVersionUID', 'JSON', 'Jackson', 'Externalizable', 'Deserialization', 'Protocol Buffers'],
      content: [
        {
...
List<UserDto> users = mapper.readValue(jsonArray,
    ...
    },
    {
      ...
      icon: '🔌',
      difficulty: 'Advanced',
      tags: ['SPI', 'ServiceLoader', 'Plugin', 'JDBC', 'Service Discovery', 'Extensibility', 'META-INF'],
      content: [
        {
          heading: 'What is SPI',
...
MessageService service = loader.stream()
    ...
    },
    {
      ...
      icon: '💰',
      difficulty: 'Intermediate',
      tags: ['BigDecimal', 'Precision', 'Floating Point', 'Money', 'Rounding', 'Arithmetic', 'Financial Calculation'],
      content: [
        {
...
new BigDecimal("2.0").compareTo(new BigDecimal("2.00"));    // 0 (equal)`
    ...
    },
    {
      ...
      icon: '☢️',
      difficulty: 'Advanced',
      tags: ['Unsafe', 'CAS', 'Memory', 'Off-Heap', 'Internal', 'VarHandle', 'Foreign Memory API', 'Low-Level'],
      content: [
        {
...
public class SafeCounter {
    ...
    },
    {
      ...
      icon: '🧩',
      difficulty: 'Intermediate',
      tags: ['Pattern Matching', 'Sealed Classes', 'Records', 'Java 21', 'Switch', 'Algebraic Data Types', 'Deconstruction', 'Type Safety'],
      content: [
        {
