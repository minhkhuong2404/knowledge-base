...
export const NEW_FEATURES_TOPICS: Topic[] = [
  {
    ...
    description:
      'Lambda expressions, Stream API, Optional, Date/Time API, default methods — the biggest Java release ever.',
...
Map<String, Double> avgSalary = employees.stream()
  ...
  },
  {
    ...
    description:
      'Module system, var, HTTP Client, records, sealed classes, text blocks, switch expressions, and more.',
    categoryId: 'new-features',
    icon: '🔢',
...
// Its module name is derived from the JAR filename or Automatic-Module-Name manifest`,
  ...
  },
  {
    ...
    description:
      'Virtual threads, pattern matching for switch, record patterns, sequenced collections, and structured concurrency.',
    categoryId: 'new-features',
    icon: '🚀',
    difficulty: 'Advanced',
    tags: [
