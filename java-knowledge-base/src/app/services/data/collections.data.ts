...
export const COLLECTIONS_TOPICS: Topic[] = [
  {
    ...
    description:
      'The Java Collections hierarchy — List, Set, Queue, Map, and choosing the right implementation.',
...
Comparator<Employee> bySalaryDesc = bySalaryAsc.reversed();`,
  ...
  },
  {
    ...
    description:
      'Internal array structure, dynamic resizing, capacity growth strategy, and performance characteristics.',
    categoryId: 'collections',
    icon: '📋',
...
System.out.printf("Insert at head — ArrayList: %d ms, LinkedList: %d ms%n",
  ...
  },
  {
    ...
    description:
      'Hash function, bucket structure, treeification, resize mechanism, and why equals/hashCode matter.',
    categoryId: 'collections',
    icon: '🗺️',
    difficulty: 'Advanced',
    tags: [
...
// - Even with treeification, still much worse than O(1) with spread hashes`,
  ...
  },
  {
    ...
    description:
      'Segment locking (Java 7) vs CAS + synchronized (Java 8+), concurrent operations, and how it achieves thread safety.',
    categoryId: 'collections',
    icon: '🔒',
    difficulty: 'Advanced',
    tags: [
...
registry.compute("listeners", (key, existing) -> {
  ...
  },
  {
    ...
    description:
      'Insertion-order / access-order iteration, and building an LRU cache with LinkedHashMap.',
    categoryId: 'collections',
    icon: '🔗',
    difficulty: 'Intermediate',
    tags: [
...
for (var entry : accessOrder.entrySet()) {
  ...
  },
  {
    ...
    description:
      'Binary heap implementation, sift-up/sift-down operations, and use cases for priority queues.',
    categoryId: 'collections',
    icon: '⏫',
    difficulty: 'Intermediate',
    tags: [
...
// Output: [1, 2, 3, 4, 5, 6, 7, 8, 9]`,
  ...
  },
  {
    ...
    description:
      'Common mistakes with collections — fail-fast iterators, Arrays.asList traps, and performance anti-patterns.',
    categoryId: 'collections',
    icon: '🚫',
    difficulty: 'Intermediate',
    tags: [
